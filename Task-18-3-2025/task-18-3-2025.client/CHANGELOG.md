...
- Create Angular project with ng: `ng new task-18-3-2025.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`task-18-3-2025.client.esproj`).
